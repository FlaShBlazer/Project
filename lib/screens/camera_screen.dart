...
import 'package:project/screens/gallery.dart';
import 'package:project/screens/video_timer.dart';
...
class CameraScreenState extends State<CameraScreen>
  ...
  void _captureImage() async {
    ...
    if (_controller.value.isInitialized) {
      ...
      print('path: $filePath'); //Image path
  ...
  Future<String> startVideoRecording() async {
    ...
    print("path: $filePath"); //here is your video path:)
